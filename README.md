...
- 🎯 Entry points to execute your program using `python -m <test_tool>` or `$ test_tool` with basic CLI argument parsing.
...
Awesome test_tool created by jackovsky8

## Install it from PyPI

```bash
pip install test_tool
```

## Usage

```py
from test_tool import BaseClass
from test_tool import base_function

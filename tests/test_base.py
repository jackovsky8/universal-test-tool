...
def test_import_plugin_wrong_members_type() -> None:
    ...
    assert "Module test_tool_mock_plugin is not a valid plugin, "\
        "default_mock_call is not a <class 'dict'>" in str(
...
def test_make_all_calls_stop_on_error() -> None:
    ...
    class FailureCallMock(object):
        ...
        """
        @staticmethod
        def make_mock_call(*args, **kwargs) -> None:  # pylint: disable=unused-argument
            """
            A mock function for make_timing_call.
            """
...
def test_load_config_yaml() -> None:
    ...
    test_config = {
        "test_tool": "test_tool_mock_plugin"
    }
    # write as yaml
